...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{This is a simple RPN (Reverse Polish Notation) gem.}
  spec.description   = %q{This gem can do the four basic operators for RPN (Reverse Polish Notation).}
